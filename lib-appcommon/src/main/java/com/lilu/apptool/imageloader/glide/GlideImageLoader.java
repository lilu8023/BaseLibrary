...
public class GlideImageLoader implements IImageLoader {
    ...
    //统一的加载占位图
    public static final int DEFAULT_RES = R.drawable.brvah_sample_footer_loading;
    //统一的错误占位图
    public static final int ERROR_RES = R.drawable.brvah_sample_footer_loading_progress;
