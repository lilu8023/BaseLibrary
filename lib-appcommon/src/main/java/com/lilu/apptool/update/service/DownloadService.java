...
package com.lilu.apptool.update.service;
...
public class DownloadService extends Service {
    ...
    public static void bindService(ServiceConnection connection) {
        Intent intent = new Intent(Update.getContext(), DownloadService.class);
        Update.getContext().startService(intent);
        Update.getContext().bindService(intent, connection, Context.BIND_AUTO_CREATE);
        mIsRunning = true;
    }
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle(getString(R.string.update_start_download))
                .setContentText(getString(R.string.update_connecting_service))
//                .setSmallIcon(R.drawable.update_icon_app_update)
    ...
    private void startDownload(@NonNull UpdateEntity updateEntity, @NonNull FileDownloadCallBack fileDownloadCallBack) {
        ...
        if (TextUtils.isEmpty(apkUrl)) {
            String contentText = getString(R.string.update_tip_download_url_error);
            stop(contentText);
            return;
        }
    ...
    private class FileDownloadCallBack implements IUpdateHttpService.DownloadCallback {
        ...
        public void onProgress(float progress, long total) {
            ...
            if (canRefreshProgress(rate)) {
                ...
                if (mBuilder != null) {
                    mBuilder.setContentTitle(getString(R.string.update_lab_downloading) + UpdateUtils.getAppName(DownloadService.this))
                            .setContentText(rate + "%")
        ...
        private void handleOnSuccess(File file) {
            ...
            try {
                if (UpdateUtils.isAppOnForeground(DownloadService.this)) {
                    ...
                    if (mIsAutoInstall) {
                        XUpdate.startInstallApk(DownloadService.this, file, mDownloadEntity);
                    } else {
        ...
        public void onError(Throwable throwable) {
            ...
            XUpdate.onUpdateError(UpdateError.ERROR.DOWNLOAD_FAILED, throwable != null ? throwable.getMessage() : "unknown error!");
            //App前台运行
    ...
    private void showDownloadCompleteNotification(File file) {
        ...
        mBuilder.setContentIntent(contentIntent)
                ...
                .setContentText(getString(R.string.update_download_complete))
