...
package com.lilu.apptool.update.listener.impl;
...
import static com.lilu.apptool.update.entity.UpdateError.ERROR.INSTALL_FAILED;
...
public class DefaultInstallListener implements OnInstallListener {
    ...
    public boolean onInstallApk(@NonNull Context context, @NonNull File apkFile, @NonNull DownloadEntity downloadEntity) {
        if (checkApkFile(downloadEntity, apkFile)) {
            ...
            XUpdate.onUpdateError(INSTALL_FAILED, "Apk file verify failed, please check whether the MD5 value you set is correct！");
            return false;
        }
    }
