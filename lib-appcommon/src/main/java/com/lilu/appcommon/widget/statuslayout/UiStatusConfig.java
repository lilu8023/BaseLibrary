...
public class UiStatusConfig {
     ...
     * 状态数量.
     */
    public static final int UI_STATUS_SIZE = 10;
    ...
    static {
        ...
        ID_ROUTER.put(UiStatus.WIDGET_FLOOR, R.id.view_stub_bottom_floor);
        ID_ROUTER.put(UiStatus.WIDGET_FLOAT, R.id.view_stub_float);
    }
